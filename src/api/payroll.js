...
function mapDetail(r) {
  return {
    ...
    extraWorkTotal: Number(r.extra_work_total) || 0, extraWorkDetail: r.extra_work_detail || [],
    leaveDays: Number(r.leave_days) || 0, absentNoPermission: Number(r.absent_no_permission) || 0,
    lateTimes: r.late_times || 0, forgotClockTimes: r.forgot_clock_times || 0,
...
export async function savePayrollDetails(payrollId, details) {
  ...
  const rows = details.map(d => ({
    ...
    extra_work_total: d.extraWorkTotal || 0, extra_work_detail: d.extraWorkDetail || [],
    leave_days: d.leaveDays || 0, absent_no_permission: d.absentNoPermission || 0,
    late_times: d.lateTimes || 0, forgot_clock_times: d.forgotClockTimes || 0,
